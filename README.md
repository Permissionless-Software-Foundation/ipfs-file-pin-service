...
ipfs-file-pin-service is part of the **optional** IPFS layer in the [Cash Stack](https://cashstack.info).

![ipfs-file-pin-service dependency graph](./dev-docs/ipfs-file-pin-service-dependency-graph.png)
