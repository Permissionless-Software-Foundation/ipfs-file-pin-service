...
import LocalRESTController from './local/index.js'
...
class RESTControllers {
  ...
  attachRESTControllers (app) {
    ...
    // Attach the REST API Controllers associated with the /local route
    const localRESTController = new LocalRESTController(dependencies)
    localRESTController.attach(app)
  }
}
