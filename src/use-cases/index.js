...
import IpfsUseCases from './ipfs.js'
import { UsageUseCases } from './usage-use-cases.js'
import ModerationUseCases from './moderation.js'
...
class UseCases {
  constructor (localConfig = {}) {
    ...
    this.moderation = new ModerationUseCases(localConfig)
  }

  // Run any startup Use Cases at the start of the app.
  async start () {
    await this.ipfs.getWritePrice({ claimTxDetails: { height: 893170 } })
